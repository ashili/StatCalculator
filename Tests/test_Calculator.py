...
class MyTestCase(unittest.TestCase):
    ...
    def test_add(self):
        testData = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Addition.csv').data
        for row in testData:
    ...
    def test_subtract(self):
        testData1 = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Subtraction.csv').data
    ...
    def test_multiply(self):
        testData1 = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Multiplication.csv').data
        for row in testData1:
    ...
    def test_divide(self):
        testData1 = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Division.csv').data
        for row in testData1:
    ...
    def test_square(self):
        testData1 = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Square.csv').data
        for row in testData1:
    ...
    def test_radical(self):
        testData1 = CsvReader('StatCalculator/Tests/csvFiles/Unit Test Square Root.csv').data
        for row in testData1:
